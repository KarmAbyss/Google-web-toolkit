...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "HELLOO" because\n';
  ...
  $wnd.__gwt_activeModules['HELLOO'] = {
    'moduleName' : 'HELLOO',
    'bindings' : function() {
      return {};
    }
 ...
 * "/HELLOO.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['HELLOO'].superdevmode = true;

  var expectedSuffix = '/HELLOO.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + HELLOO + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:HELLOO';
  var devModeSessionKey = '__gwtDevModeSession:HELLOO';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/HELLOO/HELLOO.nocache.js';
  ...
  $wnd.__gwt_activeModules['HELLOO'].canRedirect = true;
  $wnd.__gwt_activeModules['HELLOO'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/HELLOO?user.agent=' + ua + '&_callback=' + callback;
